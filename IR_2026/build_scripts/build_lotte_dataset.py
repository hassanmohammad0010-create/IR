...
RAW_JSONL = ROOT / "datasets" / "dataset1" / "lotte_writing_forum.jsonl"
PROCESSED_JSONL = ROOT / "data" / "processed" / "lotte_writing_processed.jsonl"

INDEX_DIR = ROOT / "data" / "indexes" / "lotte"
